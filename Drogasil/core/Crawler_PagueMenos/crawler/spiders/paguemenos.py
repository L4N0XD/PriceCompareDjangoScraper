...
from .custom_settings.paguemenos_settings import settings
...
class PagueMenosSpider(SitemapSpider):
    ...
    def __init__(self, *args, **kwargs):
        super(PagueMenosSpider, self).__init__(*args, **kwargs)
        self.products_list = []
    ...
    def parse(self, response):
        ...
        json_page = response.xpath('//script[@type="application/ld+json"]/text()').get()
